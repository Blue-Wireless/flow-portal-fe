...
import type { DeviceNode, FilterMeta, StatCardMeta, TerminalNode } from "./types";

export const terminalNodes: TerminalNode[] = [
  { id: "syd", name: "Sydney", latitude: -33.8688, longitude: 151.2093, status: "online" },
  { id: "mel", name: "Melbourne", latitude: -37.8136, longitude: 144.9631, status: "offline" },
  { id: "bne", name: "Brisbane", latitude: -27.4698, longitude: 153.0251, status: "online" },
  { id: "per", name: "Perth", latitude: -31.9505, longitude: 115.8605, status: "online" },
  { id: "adl", name: "Adelaide", latitude: -34.9285, longitude: 138.6007, status: "offline" },
  { id: "cbr", name: "Canberra", latitude: -35.2809, longitude: 149.13, status: "online" },
  { id: "drw", name: "Darwin", latitude: -12.4634, longitude: 130.8456, status: "offline" },
  { id: "hob", name: "Hobart", latitude: -42.8821, longitude: 147.3272, status: "online" },
];
...
export const generateDeviceNodes = (count: number = 30): DeviceNode[] => {
  return Array.from({ length: count }).map((_, i) => {
    ...
    return {
      ...
      lastSeenAt: randomRecentIso(),
      signalPct: isOnline ? randomInt(60, 100) : randomInt(0, 50),
    };
  });
};

// ✅ API-provided UI metadata (filters + stat cards)
